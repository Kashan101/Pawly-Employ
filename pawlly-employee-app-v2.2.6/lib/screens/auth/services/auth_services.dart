...
class AuthServiceApis {
  static Future<RegUserResp> createUser({dynamic request,bool isFormData = false}) async {
    return RegUserResp.fromJson(await handleResponse(await buildHttpResponse(APIEndPoints.register, request: request, method: HttpMethodType.POST,isFormData: isFormData)));
  }
